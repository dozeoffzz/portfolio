...
export const AllWeb = [
  {
    ...
    kind: "Funiture Shop",
    team: "Team Project",
    info: "프론트엔드 부트캠프에서 진행한 파이널 프로젝트 입니다. 프로젝트는 미니 e커머스를 제작하는 내용이었고 팀장으로써 프로젝트를 진행하였습니다. 주로 레퍼러스탐색, 디자인, 퍼블리싱,배포,의견 조율 등 이었습니다. 팀장으로써 팀원분들의 소통에 집중하고 작업이 원활이 진행될 수 있게 진행하는 것이 힘들고 버겁기도 하였지만, 팀원분들에게 들었던 최고의 팀장 이라는 칭찬이 뿌듯하고 더욱 열심히 할 수 있게된 계기가 되었습니다.",
    img: web2kea,
